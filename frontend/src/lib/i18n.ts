...
const dictionary = {
  en: {
    ...
    telegramConnect: 'Connect Telegram to this web account',
    telegramDisconnect: 'Disconnect',
    telegramConnected: 'Connected',
    telegramNotConnected: 'Not connected',
    telegramCodeMsg: 'Send this code to our Telegram Bot to link this web account:',
    telegramOpenBot: 'Click the button below to link this web account in Telegram:',
  ...
  ko: {
    ...
    telegramConnect: '웹 계정에 텔레그램 연결',
    telegramDisconnect: '연결 해제',
    telegramConnected: '연결됨',
    telegramNotConnected: '미연결',
    telegramCodeMsg: '현재 웹 계정을 연결하려면 이 코드를 텔레그램 봇에 전송하세요:',
    telegramOpenBot: '아래 버튼을 눌러 현재 웹 계정을 텔레그램에 연결하세요:',
