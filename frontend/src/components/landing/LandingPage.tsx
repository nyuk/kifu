...
function FeatureCard({ icon, title, desc }: { icon: string; title: string; desc: string }) {
    return (
        <div className="group rounded-2xl border border-neutral-200 bg-white p-6 transition-all duration-300 hover:border-neutral-300 hover:shadow-lg hover:shadow-neutral-200/50">
            <div className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-neutral-100 text-lg">
                {icon}
            </div>
            <h4 className="mt-4 text-[15px] font-semibold text-neutral-900">{title}</h4>
        ...
        <div className="min-h-screen bg-white text-neutral-900 antialiased">
            ...
            <nav className="fixed top-0 z-50 w-full border-b border-neutral-100 bg-white/80 backdrop-blur-md">
                <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
                    <span className="text-lg font-bold tracking-wider text-indigo-600">KIFU</span>
            ...
            <section className="relative min-h-screen overflow-hidden">
                ...
                <div className="relative z-10 mx-auto grid max-w-6xl items-center gap-16 px-6 pt-32 pb-20 lg:grid-cols-[1.2fr_0.8fr] lg:pt-40">
                    {/* Left: Copy */}
                    <div>
                        <div className="inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-50 px-4 py-1.5 text-xs font-medium text-indigo-600">
                            <span className="h-1.5 w-1.5 rounded-full bg-indigo-500 animate-pulse" />
                            얼리 액세스 무료
                        </div>

                        <h1 className="mt-8 text-5xl font-bold leading-[1.1] tracking-tight text-neutral-900 md:text-7xl">
                            매매 복기를
                            <br />
                        ...
                        <div className="mt-10 flex flex-wrap gap-4">
                            <a
                                ...
                                className="group inline-flex items-center gap-2.5 rounded-full bg-indigo-600 px-7 py-3.5 text-sm font-semibold text-white transition-all hover:bg-indigo-700 hover:shadow-lg hover:shadow-indigo-300/40"
                            >
                            ...
                            <Link
                                href="/register"
                                className="inline-flex items-center rounded-full border border-neutral-300 px-7 py-3.5 text-sm font-semibold text-neutral-700 transition-all hover:border-neutral-400 hover:bg-neutral-50"
                            >
                                웹에서 시작
                            </Link>
                        </div>
            ...
            {/* Stats bar */}
            <section className="relative z-10 border-y border-neutral-100 bg-neutral-50/80">
                <div className="mx-auto flex max-w-4xl items-center justify-around py-10">
                    {[
                        ...
                        <div key={stat.label} className="text-center">
                            <p className="text-3xl font-bold text-indigo-600 md:text-4xl">{stat.value}</p>
                ...
                <div className="mx-auto max-w-4xl px-6">
                    <div className="text-center">
                        <h2 className="text-4xl font-bold text-neutral-900 md:text-5xl">
                            엑셀은 <span className="text-neutral-300">그만</span>
                        </h2>
                        <p className="mt-4 text-lg text-neutral-500">기록이 귀찮으면 안 하게 됩니다. 그래서 15초로 만들었습니다.</p>
                    </div>

                    <div className="mt-16 grid gap-6 md:grid-cols-2">
                        {/* Before */}
                        <div className="rounded-2xl border border-neutral-200 bg-neutral-50 p-8">
                            <p className="text-xs font-semibold uppercase tracking-widest text-neutral-400">기존</p>
                            <ul className="mt-6 space-y-4">
                                {[
                                    ...
                                    <li key={item} className="flex items-center gap-3 text-sm text-neutral-400">
                                        <span className="flex h-5 w-5 items-center justify-center rounded-full bg-neutral-200 text-[10px] text-neutral-400">✕</span>
                                        {item}
                                    </li>
                                ))}
                            </ul>
                        ...
                        <div className="rounded-2xl border border-indigo-200 bg-indigo-50 p-8">
                            <p className="text-xs font-semibold uppercase tracking-widest text-indigo-600">KIFU</p>
                            <ul className="mt-6 space-y-4">
                                {[
                                    '알림 오면 15초 만에 기록',
                                    '실수 패턴이 숫자로 보임',
            ...
            <section className="relative py-32 bg-neutral-900 text-white overflow-hidden">
                {/* Gradient accent */}
                <div className="absolute inset-0 overflow-hidden">
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-indigo-600/20 blur-[150px]" />
                </div>

                <div className="relative mx-auto max-w-3xl px-6 text-center">
                    <div className="inline-flex items-center gap-2 rounded-full border border-emerald-400/30 bg-emerald-400/10 px-4 py-1.5 text-xs font-medium text-emerald-300">
                        모든 기능 무료
                    </div>
                    ...
                    <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2.5 rounded-full bg-white px-8 py-4 text-sm font-semibold text-neutral-900 transition-all hover:bg-neutral-100 hover:shadow-lg"
                        >
                            <svg className="w-5 h-5 text-indigo-600" viewBox="0 0 24 24" fill="currentColor"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg>
                            텔레그램으로 시작
                        </a>
                        <Link
                            href="/register"
                            className="inline-flex items-center rounded-full border border-white/20 px-8 py-4 text-sm font-semibold text-white/80 transition-all hover:border-white/40 hover:text-white"
                        >
                            웹에서 가입
                        </Link>
                    </div>
                    ...
                    <div className="mt-12 flex flex-wrap justify-center gap-3">
                        {['텔레그램 복기 봇', '자동 거래 매칭', '패턴 분석', '가격 알림', 'AI 의견 비교', '거래소 연동'].map((f) => (
                            <span key={f} className="rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-xs text-white/40">
                                {f}
                            </span>
                        ))}
                    </div>
            ...
            <footer className="border-t border-neutral-100 bg-white py-12">
                <div className="mx-auto max-w-6xl px-6 flex items-center justify-between">
                    <span className="text-sm font-bold text-indigo-600">KIFU</span>
                    <p className="text-xs text-neutral-400">&copy; 2026 KIFU. 매매 복기를 습관으로.</p>
                </div>
            </footer>
        </div>
    )
