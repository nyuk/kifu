      ...
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-4xl items-start justify-center md:items-center">
        <div className="w-full space-y-5 md:space-y-6">
          <header className="space-y-2">
            ...
            <h1 className="text-2xl font-semibold md:text-3xl">어떻게 시작할까요?</h1>
          ...
          <section className="grid gap-3 md:grid-cols-3 md:gap-4">
            ...
            <article className="rounded-2xl border border-neutral-800/60 bg-neutral-900/60 p-4 md:p-5">
            ...
            {/* Option B: API 연동 */}
            <article className="relative rounded-2xl border border-sky-500/30 bg-sky-500/10 p-4 md:p-5">
